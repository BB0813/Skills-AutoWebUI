...
// Validate ../../../src/app/api/save-skill/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/save-skill">> = Specific
  const handler = {} as typeof import("../../../src/app/api/save-skill/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
